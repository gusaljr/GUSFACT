					...
					<ul class="navbar-nav navbar-align">
							...
							<div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0"
								...
								<div class="list-group">
									<a href="#" class="list-group-item">
										<div class="row g-0 align-items-center">
											<div class="col-2">
												<img src="public/static/img/avatars/avatar-5.jpg"
									...
									<a href="#" class="list-group-item">
										<div class="row g-0 align-items-center">
											<div class="col-2">
												<img src="public/static/img/avatars/avatar-2.jpg"
									...
									<a href="#" class="list-group-item">
										<div class="row g-0 align-items-center">
											<div class="col-2">
												<img src="public/static/img/avatars/avatar-4.jpg"
						...
						<li class="nav-item dropdown">
							...
							<a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#"
								data-bs-toggle="dropdown">
								<img src="public/static/img/avatars/avatar.jpg" class="avatar img-fluid rounded me-1"
							...
							<div class="card">
								<div class="card-header">
									<div class="container mt-5 ">
										<h2> Crear Usuario </h2>
										<div id="empresasSelect" >
											<p>Selecciona minimo una empresa por usuario</p>
											<div class="col-lg-12" id="Empbtn"></div>
										</div>
										<form action="index.php?web=login_addUser2" method="POST" class="row" id="formRU">
											<!-- Nombre -->
											<div class="mb-3">
											...
											<div class="mb-3">
												...
												<select class="form-select" id="rol_id" name="rol_id" required>
													...
													<option value="3">Otro Rol</option>
												</select>
											</div>
