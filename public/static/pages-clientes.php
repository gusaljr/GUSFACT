	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">Fact - Gus</span>
              ...
              <i class="align-middle" data-feather="user-plus"></i> <span class="align-middle">Add User</span>
					...
					<li class="sidebar-item ">
						<a class="sidebar-link" href="index.php?web=blank">
              <i class="align-middle" data-feather="book"></i> <span class="align-middle">Blank</span>
					...
					<li class="sidebar-item active">
						<a class="sidebar-link" href="index.php?web=addCliente">
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
							...
							<div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" aria-labelledby="messagesDropdown">
								...
								<div class="list-group">
									<a href="#" class="list-group-item">
										<div class="row g-0 align-items-center">
											<div class="col-2">
												<img src="public/static/img/avatars/avatar-5.jpg" class="avatar img-fluid rounded-circle" alt="Vanessa Tucker">
											</div>
									...
									<a href="#" class="list-group-item">
										<div class="row g-0 align-items-center">
											<div class="col-2">
												<img src="public/static/img/avatars/avatar-2.jpg" class="avatar img-fluid rounded-circle" alt="William Harris">
											</div>
											<div class="col-10 ps-2">
									...
									<a href="#" class="list-group-item">
										<div class="row g-0 align-items-center">
											<div class="col-2">
												<img src="public/static/img/avatars/avatar-4.jpg" class="avatar img-fluid rounded-circle" alt="Christina Mason">
											</div>
											<div class="col-10 ps-2">
									...
									<a href="#" class="list-group-item">
										<div class="row g-0 align-items-center">
											<div class="col-2">
												<img src="public/static/img/avatars/avatar-3.jpg" class="avatar img-fluid rounded-circle" alt="Sharon Lessman">
											</div>
											<div class="col-10 ps-2">
                ...
                <img src="public/static/img/avatars/avatar.jpg" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark"><?php echo $_SESSION['user']['username']?></span>
              </a>
							<div class="dropdown-menu dropdown-menu-end">
								<a class="dropdown-item" href="index.php?web=profile"><i class="align-middle me-1" data-feather="user"></i> Profile</a>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Añadir Clientes</h1>
					...
					<div class="row">
						<div class="col-12">
							<div class="card">
								...
								<div class="card-body">
								<form action="index.php?web=add_cliente" method="POST" class="row">
											<!-- Nombre -->
											<div class="mb-3">
											...
											<div class="mb-1 col-6">
												...
												<input type="text" class="form-control" id="pais" name="pais" maxlength="255" required>
											</div>

											<div class="mb-1 col-6" >
												<label for="localidad" class="form-label">Localidad</label>
												<input type="text" class="form-control" id="localidad" name="localidad" maxlength="255" required>
											</div>
											...
											<div class="mb-1 col-6">
												...
												<input type="text" class="form-control" id="provincia" name="provincia" maxlength="255" required>
											</div>

											<!-- Fecha de Nacimiento -->
											

											<button type="submit" class="btn mt-3 btn-primary">Crear Usuario</button>
										</form>
								</div>
							</div>
						</div>
